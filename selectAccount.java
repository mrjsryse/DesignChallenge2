...
public class selectAccount extends JFrame{
	...
	accountList list;
	public JButton btnSignUp,btnGuestAccount,btnRegisteredAccount,btnTest;
	...
	public selectAccount() {
		...
		btnTest.setBounds(245, 570, 89, 23);
		backgroundPanel.add(btnTest);
...
//		btnRegisteredAccount.addActionListener(new registeredButton());
		btnTest.addActionListener(new testingButton());
...
//}
	...
	class testingButton implements ActionListener
	{
	public void actionPerformed (ActionEvent e)
		{
	...
	public void addAccount(signingUp signUpData) {
